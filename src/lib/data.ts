...
export const courses: Course[] = [
  { 
    ...
    priceKey: 'courses.flightAttendant.price',
  ...
  { 
    ...
    priceKey: 'courses.luxuryRestaurant.price',
  ...
  { 
    ...
    priceKey: 'courses.luxuryHotel.price',
  ...
  { 
    ...
    priceKey: 'courses.sommelier.price',
  ...
  { 
    ...
    priceKey: 'courses.fashionModel.price',
  ...
  { 
    ...
    priceKey: 'courses.businessChina.price',
  ...
  { 
    ...
    priceKey: 'courses.gatewayEurope.price',
  ...
  },
  {
    ...
    priceKey: 'courses.footballCoach.price',
  ...
  },
  {
    ...
    priceKey: 'courses.fifaAgent.price',
  ...
  },
  {
    ...
    priceKey: 'courses.sportsData.price',
