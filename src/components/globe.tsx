...
export function Globe() {
  ...
  useEffect(() => {
    ...
    const pointMaterial = new THREE.MeshBasicMaterial({ color: 0xc5a059 });
    points.forEach(p => {
    ...
    const arcMaterial = new THREE.MeshBasicMaterial({ color: 0xc5a059, transparent: true, opacity: 0.7 });
