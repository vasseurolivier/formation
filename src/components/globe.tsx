...
export function Globe() {
  ...
  useEffect(() => {
    ...
    const pointMaterial = new THREE.MeshBasicMaterial({ color: 0xfacc15 });
    points.forEach(p => {
    ...
    const arcMaterial = new THREE.MeshBasicMaterial({ color: 0xfacc15, transparent: true, opacity: 0.7 });
